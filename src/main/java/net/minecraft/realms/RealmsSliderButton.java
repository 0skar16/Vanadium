...
public class RealmsSliderButton extends RealmsButton
{
    ...
    public void renderBg(int p_renderBg_1_, int p_renderBg_2_)
    {
        if (this.getProxy().field_146125_m)
        {
            if (this.sliding)
            {
                this.value = (float)(p_renderBg_1_ - (this.getProxy().x + 4)) / (float)(this.getProxy().getWidth() - 8);
    ...
    {
        this.value = (float)(p_clicked_1_ - (this.getProxy().x + 4)) / (float)(this.getProxy().getWidth() - 8);
